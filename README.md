...
│
├── hardware/
│   ├── EEG_Circuit.pdf                                             PDF/KiCad:  Schematic of complete analog circuit
│   ├── EEG_Differential_Mode_ADC_For_Full_Scale_Range.pdf          PDF/KiCad:  Schematic of complete analog circuit for differential mode operation
│   ├── EEG_LTspice Simulation/
│   │	├── EEG.asc                                                 LTspice:    Simulated analog circuit and filter behavior
│   │	├── EEG_Differential_Into_ADC_For_Full_Scale_Range.asc      LTspice:    Simulated analog circuit and filter behavior for differential mode operation
│   │	└── Supporting .raw and .lib files                          LTspice:    Required files for LTspice Simulation, including AD620 module
│   └── Breadboard.jpg                                              JPEG:       Image of the final circuit
│
├── data_acquisition/
...
│
├── feature_extraction/
│   ├── hjorth_params_and_fft_viewer.py                             Python:     Real-time bandpower computation and Hjorth parameters visualizer
│   └── Feature_Extraction.png                                      PNG:        Screenshot of Hjorth parameter and FFT visualizer with live data
│
└── technical_report/
    └── Low Cost Modular EEG using Raspberry PI.pdf                 PDF:        Describes the end-to-end system design, code, and considerations, along with showcased visualizations
```
## Sources
